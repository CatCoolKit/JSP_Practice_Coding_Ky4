...
public class UpdateProduct extends HttpServlet {
    private final String LISTPRODUCT = "productList.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Product pd = new Product(productId, productName, productImage, brief, birthday, type, account, unit, price, discount);
        pdd.updateRec(pd);
