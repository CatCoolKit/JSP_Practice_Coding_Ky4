...
public class TileManager {
    GamePanel gp;
    //Tạo mảng chứa các phần tử là những viên gạch như đất, nước, tường...
    public Tile[] tile;
    //Mảng chứa giá trị để vẽ từng ô gạch trên màn hình trò chơi theo từng cặp 
    ...
    //Lấy hình ảnh các viên gạch và từng phần tử trong mảng tile
    ...
    //Đọc từ file được để vào, đọc từng dòng truyền vào mảng numbers (dữ liệu trong mảng numbers là để xác định ô đó sẽ vẽ gì)
    //Sau đó dùng mảng hai chiều mapTileNum để lưu lại giá trị đó ví dụ vị trí x:0 y:0 sẽ vẽ ô 1 là 
    ...
    //Vẽ map sẽ dựa vào dữ liệu trong mapTileNum để xác định mỗi vị trí sẽ vẽ gì
    public void draw(Graphics2D g2){
        ...
        while(worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow){
            ...
            //Xác định tọa độ 4 cạnh của vùng va chạm của nhân vật
